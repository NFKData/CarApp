...
public interface CarService {
	 ...
	 * 
	 * @param id
	 *            UUID to look for on the system
	 * @return The requested car, if found {@link Car}
	 */
	 ...
	 * 
	 * @param car
	 *            The car to be inserted
	 * @return The car if succeeded
	 * @throws CarFoundException
	 *             if there's another car with the same ID {@link Car}
	 */
	 ...
	 * 
	 * @param car
	 *            The car to be updated with new data
	 * @return The updated car
	 * @throws CarNotFoundException
	 *             if there's no car with the ID of the received one {@link Car}
	 */
	 ...
	 * 
	 * @param id
	 *            UUID of the car to be deleted
	 * @throws CarNotFoundException
	 *             if there's no car with the received ID
	 */
