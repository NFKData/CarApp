...
public class DeleteBrandAction implements JMSAction {
	...
	public DeleteBrandAction(Brand brand) {
		this.brand = brand;
		InitialContext ctx;
		try {
		...
		JMSMappedActions.getInstance().registerAction(Brand.class, HttpMethod.DELETE, this);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DeleteBrandAction other = (DeleteBrandAction) obj;
		if (brand == null) {
			if (other.brand != null)
				return false;
